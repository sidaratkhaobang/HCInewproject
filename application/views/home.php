        ...
        <div class="js-carousel-1 owl-carousel">
          ...
          <div class="testimonial text-center">
            <div class="author-image mb-3">
              <img src="public/img/person_1.jpg" alt="Image placeholder" class="rounded-circle">
            </div>
            <blockquote>
          ...
          <div class="testimonial text-center">
            <div class="author-image mb-3">
              <img src="public/img/person_2.jpg" alt="Image placeholder" class="rounded-circle">
            </div>
            <blockquote>
          ...
          <div class="testimonial text-center">
            <div class="author-image mb-3">
              <img src="public/img/person_3.jpg" alt="Image placeholder" class="rounded-circle">
            </div>
            <blockquote>
